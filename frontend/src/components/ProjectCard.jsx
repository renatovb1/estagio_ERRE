...
export default function ProjectCard({ project }) {
  const projectIndex = String(project.id ?? 0).padStart(2, "0");
    ...
    <article className="project-card">
      <div className="project-main">
        ...
        <footer className="project-links">
          {project.url && (
            <a href={project.url} target="_blank" rel="noreferrer" aria-label="Demo">
          ...
          {project.repo_url && (
            <a href={project.repo_url} target="_blank" rel="noreferrer" aria-label="Repositório">
              <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="project-media">
        {project.image_url ? (
          ...
          <div className="project-image project-image-fallback">{projectIndex}</div>
        )}
      </div>
    </article>
  );
